...
const log = require("debug")("incognito:hooks");
...
export const useAllAccountsForPublicKey = (publicKey: PublicKey): [OwnedAccount<Buffer> | undefined, boolean] => {
...
export const useTokenAccountsByOwner = (publicKey: PublicKey): [OwnedAccount<Buffer>[], boolean] => {
  const { connection } = useConnection();
...
export function setInitialAccountInfo(connection: Connection, publicKey: PublicKey, accountInfo: AccountInfo<Buffer>) {
  const cacheKey = tuple(connection, publicKey.toBase58());
