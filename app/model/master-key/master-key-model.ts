...
// import { loadBackupKey, parseStorageBackup } from 'incognito-chain-web-js/build/wallet';

import { isEqual, toLower } from 'lodash';
import { BaseModel } from '../base-model';
import { MasterKeyModelInit } from './master-key-model.presets';
...
class MasterKeyModel extends BaseModel {
  ...
  constructor(data: MasterKeyModelProps = MasterKeyModelInit) {
    ...
    this.isMasterless =
      isEqual(toLower(this?.name), 'masterless') || isEqual(toLower(this?.name), 'unlinked');
  }
